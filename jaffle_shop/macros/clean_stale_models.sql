...
/*This macro will delete everything from the warehouse where the table was alter before seven days from current date. */
/*To execute the macro: dbt run-operation clean_stale_models --arg'{'dry_run':'False'}